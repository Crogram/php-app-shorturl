...
<div class="container" style="margin-top: 40px;z-index: 99999999;position: absolute;top: 25px;left: 20%;width: 60%">
    <a id="detail-link" href="javascript:void(0)" class="btn btn-primary btn-lg" role="button"><?php echo __('See details') ?></a>
    <div id="whisper-viewarea">
...
<script src="<?php echo rtrim(SUB_PATH, '/'); ?>/assets/js/crypto-js.js"></script>
...
<?php endif; ?>
    ...
    if (hash) {
        let is_auth = <?php echo $is_auth ? "true" : "false" ?>;
        ...
        function showMarkdown(whisper) {
            editormd.markdownToHTML("whisper-viewarea", {
                markdown: whisper, // + "\r\n" + $("#append-test").text(),
